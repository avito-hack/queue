...
Синхронное взаимодействие сервисов построено на REST API. Изменения количества товара, статуса объявления, отказ от тикета и погашение тикета доставляются асинхронно через RabbitMQ.
